...
<div class="custom-container">
        ...
        <div class="custom-search-bar">
            <button data-modal-toggle="add-product-modal" type="button">Agregar Producto</button>
        </div>

    </div>

    <!-- Incluir el componente modal de agregar -->
    @include('admin.modals.addProduct')
    @include('admin.modals.editProduct')
    <!-- Incluir el componente modal de eliminación -->
            ...
            <tbody>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <button data-modal-toggle="edit-product-modal">
