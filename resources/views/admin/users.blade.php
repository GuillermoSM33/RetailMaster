            ...
            <tbody>
                @foreach($users as $user)
                    <tr>
                        ...
                        <td class="actions">
                            <!-- Botón de Editar -->
                            <button @click="openModal = 'edit-user-{{ $user->id }}'" class="edit-button">
                            ...
                            <!-- Botón de Eliminar -->
                                <button type="submit" @click="openModal = {{ $user->id }}">
                    ...
                    <div x-show="openModal === {{ $user->id }}" @click.away="openModal = null"
                    ...
                    <div x-show="openModal === 'edit-user-{{ $user->id }}'" @click.away="openModal = null"
                        @keydown.escape.window="openModal = null"
                        class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
                        style="display: none;">
