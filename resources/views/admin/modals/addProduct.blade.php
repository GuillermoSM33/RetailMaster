    ...
    <div class="flex items-center justify-center min-h-screen px-4 text-center">
        ...
        <div class="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl">
            ...
            <div class="flex items-center justify-between p-4 border-b">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center" data-modal-toggle="add-product-modal">
